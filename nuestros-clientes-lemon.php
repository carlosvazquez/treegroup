...
<!-- LeftColumn -->
        <div class="span3">
          <div class="row">
            <?php include("includes/sidebartree.php");?>
          </div>
        </div>
<!-- End LeftColumn -->
...
<!-- Insertar Span's desde aqui -->
    <div class="row">
        <div class="span8 informacion justificado">
            ...
            <p><img src="img/logoslemon1.png" alt=""></p>
            <hr>
            <p><img src="img/logoslemon2.png" alt=""></p>
            <hr>
            <p><img src="img/logoslemon3.png" alt=""></p>
            <hr>
            <p><img src="img/logoslemon4.png" alt=""></p>
            <hr>
        </div>
        <div class="span1">
